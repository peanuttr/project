        ...
        <form action="../../assets/db/repair-assetments/edit-repair-asset.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <input type="text" data-provide="datepicker" data-date-language="th-th" id="reportDate" name="date" class="form-control" placeholder="วว/ดด/ปปปป" value="<?php echo $response[0]['date_notice']; ?>">
                </div>

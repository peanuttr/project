...
if (isset($_GET['id'])) {
    $_id = $_GET['id'];
    $stmt = $db->sqlQuery("SELECT a.id AS assets_id,a.assets_number,a.asset_name,dr.repair_id,r.image,r.date_notice,r.detail,r.status,r.personel_id,p.personnel_firstname,p.personnel_lastname 
        ...
        <input type="hidden" name='id' value=<?php echo $_id; ?>>
            ...
            <div class="col-3">
                ...
                <div class="col-2">
                    ...
                    <input type="text" data-provide="datepicker" data-date-language="th-th" id="reportDate" name="date" class="form-control" placeholder="วว/ดด/ปปปป" value="<?php echo $response['date_notice']; ?>">
                </div>
            ...
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <img src="<?php echo "../../assets/uploads/", $response['image'] ?>" width="50px" height="auto" alt="" srcset="" id="preview">
                </div>
            </div>

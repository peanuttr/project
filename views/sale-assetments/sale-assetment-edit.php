...
if (isset($_GET['id'])) {
    ...
    //     echo $val['assets_number'];
    // }

    // $countId = count($response['assets_id']);

    // echo "จำนวน ".count($response);
    // echo "จำนวน ".$countId;
}
...
<div class="home-section">
    <div class="home-content" style="overflow-y: auto; overflow-x: hidden; height:90%;">
        ...
        <form action="../../assets/db/selling/edit-sell-asset.php" method="POST">
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <select name="staff_id" class="form-control">
                        ...
                        ?>
                                <option value="<?php echo $res['id']; ?>"><?php echo $res[0]['staff_firstname']; ?></option>
                        <?php
                            }
                        }
                        ?>

...
if (isset($_GET['id'])) {
    $_id = $_GET['id'];
    $stmt = $db->sqlQuery("SELECT a.id AS asset_id,a.assets_number,a.asset_name,dbr.borrow_and_return_id,dbr.place_id,br.borrow_date,br.return_date,br.detail,br.personel_id,br.staff_id,p.personnel_firstname,p.personnel_lastname,s.staff_firstname,s.staff_lastname,pl.placename 
        ...
        <form action="../../assets/db/repair-assetments/edit-repair-asset.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <select name="personnel_id" class="form-control">
                        <option selected value="<?php echo $response['personel_id']; ?>"> <?php echo $response['personnel_firstname']; ?> </option>
                        <?php
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <input type="text" data-provide="datepicker" data-date-language="th-th" id="borrowDate" name="date" class="form-control" placeholder="dd-mm-yyyy" value="<?php echo $response['borrow_date']; ?>">
                </div>
                <div class="col-3">
                    <label>วันที่คืน</label>
                    <input type="text" data-provide="datepicker" data-date-language="th-th" id="returnDate" name="date" class="form-control" placeholder="dd-mm-yyyy" value="<?php echo $response['return_date']; ?>">
                </div>
                <div class="col-3">
                    <div>
                    ...
                    <select name="staff_id" class="form-control">
                        ...
                        foreach ($stmt->fetchAll() as $res) {
                            if ($res['id'] !=  $response['borrow_and_return_id']) {
                        ?>
                ...
                <div class="col-3">
                    ...
                    <select name="place_id" class="form-control">
                        <option selected value="<?php echo $response['place_id']; ?>"> <?php echo $response['placename']; ?> </option>
                        <?php
                        ...
                        foreach ($stmt->fetchAll() as $res) {
                            if ($res['id'] !=  $response['borrow_and_return_id']) {
                        ?>
                                <option value="<?php echo $res['id']; ?>"><?php echo $res['place']; ?></option>
                        <?php
                            }
                        }
                        ?>

            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href='./personnel-edit.php?id=<?php echo $result['id']; ?>' class='btn btn-sm btn-warning'>
        ...
        if (result) {
            $.ajax({
                ...
                success: function(data) {
                    data.substr(0,6) == "<br />" ? alert('ไม่สามารถลบข้อมูลได้') : window.location.href = "./personnel-management.php";
                }
            })
        }
    }

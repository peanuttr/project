...
if (isset($_POST['submit'])) {
    ...
    $stmt = $db->sqlQuery("INSERT INTO `borrow_and_return`(`borrow_date`, `return_date`, `staff_id`, `personel_id`, `status`, `detail`) VALUES ('$newFormatBorrowDate', '$newFormatReturnDate', '$staffId', '$personnelId', 'รออนุมัติ', '$detail')");
